...
class KitchenApplsPage extends StatefulWidget {
  KitchenApplsPage ({Key key}) : super(key: key);

  @override
  _KitchenApplsPageState createState() => _KitchenApplsPageState();
}

class _KitchenApplsPageState extends State<KitchenApplsPage > {
  ViewModel viewModel;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: new Text("Kitchen Appliances",
