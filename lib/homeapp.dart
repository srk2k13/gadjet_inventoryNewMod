...
class HomeApplsPage extends StatefulWidget {
  HomeApplsPage ({Key key}) : super(key: key);

  @override
  _HomeApplsPageState createState() => _HomeApplsPageState();
}

class _HomeApplsPageState extends State<HomeApplsPage > {
  ViewModel viewModel;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
        appBar: AppBar(
          ...
          title: new Text("Home Appliances",
