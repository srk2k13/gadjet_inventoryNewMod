...
import 'add_item_pages.dart';
import 'item_details.dart';
import 'inventory_custom_icons_icons.dart';
...
class MobileAccessoriesPage extends StatefulWidget {
  MobileAccessoriesPage({Key key}) : super(key: key);

  @override
  _MobileAccessoriesPageState createState() => _MobileAccessoriesPageState();
}

class _MobileAccessoriesPageState extends State<MobileAccessoriesPage> {
  ViewModel viewModel;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
        appBar: AppBar(
          ...
          title: new Text("Mobile Accessories",
