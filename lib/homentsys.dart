...
class HomeEntSysPage extends StatefulWidget {
  HomeEntSysPage ({Key key}) : super(key: key);

  @override
  _HomeEntSysPageState createState() => _HomeEntSysPageState();
}

class _HomeEntSysPageState extends State<HomeEntSysPage > {
  ViewModel viewModel;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
        appBar: AppBar(
          ...
          title: new Text("Home Entertainment System",
