...
class CamAccrsPage extends StatefulWidget {
  CamAccrsPage ({Key key}) : super(key: key);

  @override
  _CamAccrsPageState createState() => _CamAccrsPageState();
}

class _CamAccrsPageState extends State<CamAccrsPage > {
  ViewModel viewModel;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
        appBar: AppBar(
          ...
          title: new Text("Camera Accessories",
