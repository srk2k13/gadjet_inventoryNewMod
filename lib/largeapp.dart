...
class LargeAppPage extends StatefulWidget {
  LargeAppPage ({Key key}) : super(key: key);

  @override
  _LargeAppPageState createState() => _LargeAppPageState();
}

class _LargeAppPageState extends State<LargeAppPage > {
  ViewModel viewModel;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
        appBar: AppBar(
          ...
          title: new Text("Large Appliances",
